...
export default function Header() {
    ...
    return (
        <header className="bg-light-secondary p-4 lg:p-6 flex justify-between items-center border-b border-light-tertiary dark:bg-dark-secondary dark:border-dark-tertiary">
